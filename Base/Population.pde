class Population {
  ...
  void naturalSelection() {
    ...
    for (int i = 1; i< newDots.length; i++) {
      ...
      Couple couple = new Couple(parent1, parent2);

      //get baby from them
      newDots[i] = couple.gimmeBaby("discrete"); //the String argument specifies the "method of reproduction": by average or by random selection (see Couple class)
    }
